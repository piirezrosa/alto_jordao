...
<head>
    ...
    <title>FashionShop | Feminino</title>
...
<body>
    ...
    <main>
        <section class="hero" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?q=80&w=1600'); height: 500px; background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white;">
            <div class="hero-content">
                <h1 style="font-size: 3.5rem; letter-spacing: 5px; margin-bottom: 10px;">FEMININO</h1>
                <p style="font-size: 1.2rem; margin-bottom: 25px;">Elegância e tendência em cada detalhe.</p>
                <a href="#produtos" class="btn-buy-only" style="padding: 15px 40px; background: white; color: black; text-decoration: none; font-weight: bold; border-radius: 50px;">VER AGORA</a>
            </div>
        </section>
