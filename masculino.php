...
function getCaminhoImagemMasc($img) {
...
<head>
    ...
    <title>Alto Jordão | Masculino</title>
...
<body>
    ...
    <main>
        <section class="hero" style="background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?q=80&w=1600'); height: 450px; background-size: cover; background-position: center; display: flex; align-items: center; justify-content: center; text-align: center; color: white;">
            <div class="hero-content">
                <h1 style="font-size: 3.5rem; letter-spacing: 8px; margin-bottom: 10px; font-weight: 900; text-transform: uppercase;">MASCULINO</h1>
                <p style="font-size: 1.1rem; margin-bottom: 25px; opacity: 0.9; letter-spacing: 1px;">O equilíbrio entre elegância e performance.</p>
            ...
            <div class="product-grid">
                            ...
                            <div class="product-thumb">
                                ...
                                <a href="produto.php?id=<?= $p['id'] ?>" class="product-link">
                                    <div class="product-image-container">
                                        <img src="<?= getCaminhoImagemMasc($p['imagem']) ?>" 
                ...
                <?php else: ?>
                    <div style="grid-column: 1/-1; text-align: center; padding: 100px 0;">
                        <p style="color: #999; font-style: italic;">Nenhum produto masculino disponível no momento.</p>
                    </div>
                <?php endif; ?>
            </div>
        </section>
