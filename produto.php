...
<body>
    ...
    <aside id="cartSidebar" class="sidebar">
        <div style="padding: 30px; display: flex; flex-direction: column; height: 100%;">
            ...
            <div id="cartListSide" style="flex:1; overflow-y:auto;"></div>
    ...
    <main class="produto-container">
        ...
        <section class="produto-info">
            <span class="categoria"><?= htmlspecialchars($p['categoria'] ?? 'Coleção Alto Jordão') ?></span>
                ...
                <?php if(count($coresDisponiveis) > 0): ?>
                    ...
                    <div class="cores-grid">
                        <?php foreach ($coresDisponiveis as $corPT): 
                            ...
                            $corHexOuNome = traduzirCor($nomeLimpo); // Usando sua função do config
                        ?>
                            <div class="cor-opcao" 
                                 style="background-color: <?= $corHexOuNome ?>;" 
                                 title="<?= $nomeLimpo ?>"
            ...
            <div style="margin-top: 40px; border-top: 1px solid var(--border); padding-top: 30px;">
                <h4 style="text-transform: uppercase; font-size: 13px; font-weight: 900; margin-bottom: 10px;">Detalhes</h4>
